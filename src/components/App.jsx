...
import Sportsball from "./sportsball/Sportsball";
import Whatever from "./whatever/Whatever";

const queryClient = new QueryClient()

export default function App() {
  let routes
  if(location.hostname === "sportsball.localhost" || location.hostname === "sportsball.whatever.dev"){
    routes = <Routes>
  ...
  } else if (location.hostname === "whatever.localhost" || location.hostname === "whatever.dev"){
    routes = <Routes>
